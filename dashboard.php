...
<body>
    ...
    <div class="p-4 sm:ml-64 mt-14">
        <!-- <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg-lg dark:border-gray-700 mt-14"> -->
        <div class="grid grid-cols-3 gap-4 mb-4">
            <div class="col-span-2 flex items-center justify-center h-24 rounded-lg bg-gray-50 dark:bg-gray-800">
